$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            title: "Income Tax Indian Government",

            start: new Date('Nov 27, 2017 10:00'),

            end: new Date('Nov 29, 2017 00:00'),

            address: 'XYZ,ABC,New Delhi',

            description: "The Income Tax Department (also referred to as IT Department or ITD) is a government agency undertaking direct tax collection of the Government of India. It functions under the Department of Revenue of the Ministry of Finance. Income Tax Department is headed by the apex body Central Board of Direct Taxes (CBDT). Main responsibility of IT Department is to enforce various direct tax laws, most important among these being the Income-tax Act, 1961, to collect revenue for Government of India. It also enforces other economic laws like the Benami Transactions (Prohibition) Act, 1988 and the Black Money Act, 2015."
        }
    });
